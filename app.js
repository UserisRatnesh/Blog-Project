...
mongoose.connect("mongodb+srv://ratneshsingh8521127312:RatNesh@cluster0.vou1k0k.mongodb.net/BlogWebsiteDB",{ useNewUrlParser : true});
...
app.get("/posts/:postName",async function(req,res) 
{
    ...
    const foundPost = await Post.findOne({title : postName});
    if(foundPost)
    {
